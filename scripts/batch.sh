...
python stitch_images.py ../data/ ../img/items/ ../img/ 200 5 5 default 50 20 6 80000
python stitch_images.py ../data/ ../img/items/ ../img/ 200 5 5 centuries 50 20 6 80000
python stitch_images.py ../data/ ../img/items/ ../img/ 200 5 5 collections 50 20 6 80000
python stitch_images.py ../data/ ../img/items/ ../img/ 200 5 5 colors 50 20 6 80000
python stitch_images.py ../data/ ../img/items/ ../img/ 200 5 5 genres 50 20 6 80000

python generate_metadata.py ../data/src/pd_items.json ../js/items/ 5;
python generate_labels.py ../data/ ../js/labels.json 200 5 50 20 6;
python generate_coordinates.py ../data/ ../js/coords.json 200 5 5 50 20 6;
